...
<script type="text/javascript">
  ...
  $("form[name='form']").validate({
	...
	<body>
		<br><br>
		<form action="list.php" method="POST" name="form" id="form">
			...
			<table align="center" cellpadding="12">
				...
				<tr>
					...
					<td colspan="2"><input type ="radio" name="sex">Male<input type ="radio" name="sex">Female</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><select name="cars" multiple>
